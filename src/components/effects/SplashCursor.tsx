...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function clickSplat(pointer) {
      ...
      splat(pointer.texcoordX, pointer.texcoordY, dx, dy, colorObj);
    }

    function splat(x, y, dx, dy, colorObj) {
      splatProgram.bind();
      ...
      gl.uniform3f(splatProgram.uniforms.color, colorObj.r, colorObj.g, colorObj.b);
      blit(dye.write);
      dye.swap();
    }
    ...
    function updatePointerMoveData(pointer, posX, posY, colorObj) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
    ...
    function generateColor() {
      // Use the color from context
      let baseHue;
      if (color === 'green') {
        baseHue = 0.33; // Green hue
      } else if (color === 'yellow') {
        baseHue = 0.15; // Yellow hue
      } else {
        baseHue = 0; // White (low saturation)
      }
    ...
    document.body.addEventListener('mousemove', function handleFirstMouseMove(e) {
      ...
      let posX = scaleByPixelRatio(e.clientX);
      let posY = scaleByPixelRatio(e.clientY);
      let colorObj = generateColor();
      updateFrame();
      updatePointerMoveData(pointer, posX, posY, colorObj);
